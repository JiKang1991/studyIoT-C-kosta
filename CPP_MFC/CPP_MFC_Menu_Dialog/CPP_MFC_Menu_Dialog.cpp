...
#include "CPP_MFC_Menu_DialogDoc.h"
#include "CPP_MFC_Menu_DialogView.h"
#include "CTestDlg.h"
#include "CHiDlg.h"
...
BEGIN_MESSAGE_MAP(CMFCApplication1App, CWinApp)
	...
	ON_COMMAND(ID_HI, &CMFCApplication1App::OnHi)
END_MESSAGE_MAP()
...
void CMFCApplication1App::OnHi()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CHiDlg* hiDlg = new CHiDlg();
	hiDlg->DoModal();
}
